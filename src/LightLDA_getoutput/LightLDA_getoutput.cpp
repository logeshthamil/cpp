...
void LightLDA_getoutput::generate_libsvm_inputs(std::string corpus_path, std::string output_data_path) {
    std::cout << "Converting the standard corpus to libsvm format to use it as input of light lda" << std::endl;
    std::string libsvm_vocab_path = output_data_path + "libsvm_vocab_output.dat";
    std::string libsvm_corpus_path = output_data_path + "libsvm_corpus_output.dat";
...
void LightLDA_getoutput::generate_binary_from_libsvm(std::string output_data_path, std::string lda_path) {
    std::cout << "Generate the binary inputs from the libsvm format inputs" << std::endl;
    std::string libsvm_vocab_path = output_data_path + "libsvm_vocab_output.dat";
    std::string libsvm_corpus_path = output_data_path + "libsvm_corpus_output.dat";
//    std::cout << output_data_path << std::endl;
    auto convert_to_bin =
            "./dump_binary " + libsvm_corpus_path + " " + libsvm_vocab_path + " " + output_data_path + " 0";
...
void LightLDA_getoutput::apply_lda_on_binary(std::string output_data_path, std::string lda_path) {
    ...
    std::string to_1 = output_data_path + "doc_topic_output.0";
...
void LightLDA_getoutput::get_gamma_lambda(std::string output_data_path) {
